...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "bi fold glass wall residential",
    "corner opening system",
    "architectural glass wall",
    ...
    images: [
      {
        ...
        width: 1920,
        height: 1080,
        alt: "Bi-fold glass wall fully open to outdoor terrace",
      },
    ],
  },
...
const PRODUCTS = [
  ...
  },
  {
    ...
    image: "/images/folding-Corner Opening System.jpg",
  },
]
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: "url('/images/caledon-house-interrior-2.jpg')",
          }}
          role="img"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-20 gap-y-10">
            {FAQS.map((faq, i) => (
              <div key={i} className="border-t border-forma-divider pt-8">
                <h3 className="font-display text-forma-text text-xl font-light leading-snug mb-4">
                  {faq.q}
                </h3>
