...
const SYSTEMS: Record<string, SystemData> = {
  "floor-to-ceiling": {
    ...
    keywords: [
      ...
      "large format windows GTA",
      "architectural windows Ontario",
      "custom floor to ceiling windows Toronto",
    ],
  },
  "picture-windows": {
    ...
    keywords: [
      "picture windows",
      "fixed windows custom size",
      "frameless picture windows GTA",
      "modern picture window Toronto",
      "slim profile window Ontario",
    ],
  },
  "corner-glass": {
    ...
    keywords: [
      ...
      "frameless corner window system",
      "corner glass GTA",
      "90 degree corner glazing",
      "corner glass Ontario residential",
    ],
  },
  "fixed-panels": {
    ...
    keywords: [
      ...
      "large glass panels GTA",
      "commercial glass facade Ontario",
      "fixed glass wall residential",
    ],
  },
}
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://signaturespan.com/windows/${params.system}`,
    },
  }
}
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 site-container w-full pb-20 pt-44">
          <nav aria-label="Breadcrumb" className="mb-6">
            <ol className="flex items-center gap-2 font-mono text-[10px] tracking-label uppercase text-forma-white/65">
              <li>
                <Link
                  href="/windows"
                  className="hover:text-forma-gold transition-colors duration-200"
                >
                  Windows
                </Link>
              </li>
              <li aria-hidden="true" className="text-forma-white/35">
                →
              </li>
          ...
          {data.tag && (
            <p className="font-mono text-[11px] tracking-label uppercase text-forma-gold mb-4">
              {data.tag}
            </p>
          )}
        ...
        <div className="site-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28">
            <div>
              ...
              <p className="font-sans text-forma-muted text-base leading-relaxed mb-6">
                {data.body}
              </p>
      ...
      {/* ── Related systems ── */}
      <section
        className="bg-forma-surface border-y border-forma-divider"
      ...
      >
        <div className="site-container py-16">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/windows"
              className="font-mono text-[10px] tracking-label uppercase text-forma-muted hover:text-forma-gold transition-colors duration-200 self-center ml-4"
            >
              All Window Systems →
            </Link>
          </div>
