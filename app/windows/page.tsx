...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "corner glass systems",
    "picture windows",
    "modern aluminum windows",
    "custom windows residential",
    ...
    images: [
      {
        ...
        width: 1920,
        height: 1080,
        alt: "Floor-to-ceiling glass wall in a modern residence",
      },
    ],
  },
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: "url('/images/caledon-house-interrior-1.jpg')",
          }}
          role="img"
            ...
            <div className="space-y-5 lg:pt-4">
              ...
              <div className="flex items-center gap-10 pt-4">
                {[
                  ...
                  <div key={l}>
                    <p className="font-display text-forma-text text-3xl font-light">
                      {n}
                    </p>
                    <p className="font-mono text-[10px] tracking-label uppercase text-forma-muted mt-0.5">
                      {l}
                    </p>
                  </div>
                ))}
      ...
      <section
        className="bg-forma-surface border-t border-forma-divider"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              {[
                {
                  k: "Frame Material",
                  v: "Thermally broken 6063-T5 aluminium alloy",
                },
                {
                  k: "Glass Standards",
                  v: "NAFS Tested · CSA A440 · IGMA Certified",
                },
                {
                  k: "Glass Options",
                  v: "Clear · Low-iron · Tinted · Frosted · Ceramic frit",
                },
                {
                  k: "Glazing Types",
                  v: "DGU · TGU · Laminated · Acoustic · Fire-rated",
                },
                {
                  k: "Frame Finishes",
                  v: "Any RAL powder coat · Anodised · Dual-colour",
                },
                {
                  k: "Hardware",
                  v: "Architectural grade · Stainless or black powder coat",
                },
              ].map(({ k, v }) => (
                <div key={k} className="spec-row">
                  <span className="spec-key">{k}</span>
