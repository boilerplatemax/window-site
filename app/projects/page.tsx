...
const PROJECTS = [
  ...
  {
    id: 'pacific-pavilion',
    name: 'The Toronto Residence',
    location: 'Toronto, ON',
    type: 'Residential',
    tag: 'Residential',
    products: 'Bi-Fold Glass Walls · Corner Glass',
    description: 'A contemporary Toronto home where bi-fold glass walls and frameless corner glazing connect the main living level to a private rear garden.',
