    ...
    images: [
      {
        ...
        width: 1920,
        height: 1080,
        alt: "Large pivot entry door on a modern architectural residence",
      },
    ],
  },
...
const PRODUCTS = [
  ...
  },
  {
    ...
    image: "/images/entry-doors-Aluminum Entry Doors.jpg",
  },
]
...
const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Consultation",
    body: "Share your project drawings or opening dimensions. We review the structural requirements, entry orientation, and design intent.",
  },
  {
    step: "02",
    title: "Specification",
    body: "Our team produces a complete door specification: system selection, dimensions, glass type, hardware schedule, and finish.",
  },
  {
    step: "03",
    title: "Technical Package",
    body: "You receive a full technical drawing set, performance data, and hardware specifications for your documentation package.",
  },
  {
    step: "04",
    title: "Production & Delivery",
    body: "Manufactured to your specification and delivered to site with installation guidance and post-delivery technical support.",
  },
]
    ...
    <>
      ...
      >
        <div
          ...
          style={{
            backgroundImage: "url('/images/caledon-house-exterior-1.jpg')",
          }}
          role="img"
        ...
        <div className="site-container py-28 lg:py-36">
          <div className="mb-20">
            <p className="section-label-light mb-5">
              Why Entry Door Quality Matters
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {HOW_IT_WORKS.map((s) => (
              <div key={s.step} className="border-t-2 border-forma-gold pt-6">
                <p className="font-mono text-[10px] tracking-label uppercase text-forma-gold mb-4">
                  {s.step}
                </p>
                <h3 className="font-display text-forma-text text-xl font-light leading-snug mb-3">
                  {s.title}
                </h3>
                <p className="font-sans text-forma-muted text-sm leading-relaxed">
                  {s.body}
                </p>
              </div>
            ))}
