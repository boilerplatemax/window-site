    ...
    <>
      ...
      >
        <div
          ...
          style={{ backgroundImage: "url('https://images.unsplash.com/photo-1580587771525-78b9dba3b914?auto=format&fit=crop&w=1920&q=80')" }}
          role="img"
        ...
        <div className="relative z-10 site-container w-full pb-20 pt-44">
          <p className="section-label-light mb-6">Entry Door Systems</p>
